...
const ShipmentCostCard: React.FC<ShipmentCostCardProps> = ({
    ...
    const hasValidRoute = !!routeStats && Number(routeStats.distance_km) > 0;
    ...
    }, [hasValidRoute, loadKg, routeStats, vehicleType]);
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                        {!estimate ? (
                            <div className="space-y-2">
                                <div className="text-sm font-black text-slate-900">Belum ada rute.</div>
                                <div className="text-sm text-slate-500">
                                    Jalankan optimasi rute dulu supaya jarak & durasi terisi, lalu ongkir dihitung otomatis.
                                </div>
                            </div>
                        ) : (
