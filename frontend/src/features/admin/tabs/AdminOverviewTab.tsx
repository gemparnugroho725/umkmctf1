...
const StatBox: React.FC<{ label: string; value: React.ReactNode }> = ({ label, value }) => (
    <div className="p-4 rounded-2xl dr-glass border border-white/40">
    ...
    return (
        <div className="space-y-6">
            <GlassCard>
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                    <div>
                        ...
                        <p className="text-sm font-bold text-slate-800/70 mt-1">Ringkasan data & status setup SQL/RLS.</p>
            ...
            <GlassCard>
                ...
                <ul className="mt-3 text-sm text-slate-800/80 space-y-2 list-disc pl-5">
